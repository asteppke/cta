...
\version{This user manual has been generated from the CTA src tree version 1.0.3\_dirty}
...
\item
The status of the CTA can be retrieved (stopped, running)
\end{itemize}
...
The python library is available in the PSI python environment.
